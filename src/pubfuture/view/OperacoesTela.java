 ...
 */
public class OperacoesTela extends javax.swing.JFrame {

    /**
     * Creates new form OperacoesTela
     */
    public OperacoesTela() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        btTransferencias = new javax.swing.JButton();

        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        setTitle("Selecione a operação desejada");

        jPanel1.setToolTipText("");

        titulo.setText("Selecione a operação desejada:");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGap(46, 46, 46)
                .addComponent(btDespesas)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 34, Short.MAX_VALUE)
                .addComponent(btTransferencias)
                .addGap(36, 36, 36))
        );
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OperacoesTela.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JButton btTransferencias;
